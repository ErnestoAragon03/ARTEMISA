...
a = Analysis(
    ...
    datas=[
        ...
        (r'./local_tts.py', 'local_tts'),
        (r'./TTS/Local/Models/tts_models--es--mai--tacotron2-DDC','TTS/Local/Models/tts_models--es--mai--tacotron2-DDC'),
        ...
        (r'./env/Lib/site-packages/TTS','TTS'),
        (r'./env/Lib/site-packages/TTS/VERSION', 'trainer'),
